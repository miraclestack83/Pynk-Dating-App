...
class _UserTicketDetailsState extends State<UserTicketDetails> {
  GlobalKey<FormState> userComplaint = GlobalKey<FormState>();
                              ...
                              children: [
                                ...
                                Container(
                                    ...
                                    child: SingleChildScrollView(
                                      child: Text(
                                        widget
                                            .complainData[widget.index].message
                                            .toString(),
                                        style: const TextStyle(
                                          color: Color(0xff979797),
                                          fontSize: 16,
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                          ...
                                          image: NetworkImage(widget
                                              .complainData[widget.index].image
                                              .toString()),
                                        )),
                                  ),
                                ),
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    widget.complainData[widget.index].date
                                        .toString(),
                                    style: TextStyle(
                                      color: AppColors.lightPinkColor
                                          .withOpacity(0.72),
